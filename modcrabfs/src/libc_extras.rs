// This file has been lightly modified by the addition of the 'io_to_libc_error' function.
...
/// Converts an IO error to a corresponding C error code.
pub fn io_to_libc_error(error: io::Error) -> libc::c_int {
    match error.kind() {
        ...
        io::ErrorKind::UnexpectedEof => libc::EOF,
        // If the error kind is not specifically handled, return a generic error code
        _ => libc::EIO,
    }
}
